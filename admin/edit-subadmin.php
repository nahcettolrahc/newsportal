...
<html lang="en">
    <head>
        ...
        <title>Quản Lí Cộng Tác Viên</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản Lí Cộng Tác Viên</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Quản Lí Cộng Tác Viên </b></h4>
                                    <hr />
...
?>
                        		...
                        		<form class="form-horizontal" name="suadmin" method="post">
	                                   ...
	                                   <label class="col-md-2 control-label">Tên Người Dùng</label>
	                                   <div class="col-md-10">
