...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Đã Xóa Thể Loại Vĩnh Viễn";
}
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Thêm Thể Loại <i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>
