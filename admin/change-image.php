...
<strong>Có Lối</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Hình Ảnh Hiện Tại</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Chọn Ảnh Mới</b></h4>
