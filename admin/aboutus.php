                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Trang Thông Tin </h4>
...
<strong>Có Lỗi</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Cập Nhật Và Đăng</button>
