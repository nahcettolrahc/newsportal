...
<html lang="en">
    <head>
        ...
        <title>Quản Lí Thể Loại Con</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản Lí Thể Loại Con</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Thể Loại Con </a>
                                        </li>
                                        <li class="active">
                                        Quản Lí Thể Loại Con
                                        </li>
                                    </ol>
...
<strong>Thất Bại!</strong> <?php echo htmlentities($delmsg);?></div>
<?php } ?>
...
<td colspan="7" align="center"><h3 style="color:red">Không Thấy Trong CSDL</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Thể Loại Con Đã Xóa</h4>
