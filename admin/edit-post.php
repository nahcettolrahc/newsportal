                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Chỉnh Sửa Bài Đăng </h4>
...
<div class="form-group m-b-20">
<label for="exampleInputEmail1">Thể Loại Con</label>
...
<br />
<a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>">Thay Đổi Hình Ảnh</a>
</div>
</div>
</div>
