...
?>
<h1><?php echo htmlentities($row['category']);?> Tin Tức</h1>
          <div class="card mb-4">
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        ...
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" class="page-link">Trang Trước</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?> " class="page-link">Trang Tiếp Theo</a>
        </li>
